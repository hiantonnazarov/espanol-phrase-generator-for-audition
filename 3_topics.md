# Последовательные темы по `2_vocabulary.md`
...
26. **Цвета: предметы + указательные + повторение**
    Источник: `## Цвета`
    Фокус: `el colór`, `rójo`, `azúl`, `amaríllo`, `vérde`, `négro`, `blánco`, `gris`, `marrón`, `naránja`, `rósa`, `morádo`
